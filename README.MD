...
é possivel ter acesso a todos os endpoints de intenção de serviço atraves das rotas do serviço de produtos, as rotas de produtos esta na raiz do projeto basta importa no insomnia
